...
class UserDefaultHelper {
  ...
  private enum Defaults: String {
    ...
    case isAppInstallFirstTime = "com.user.isAppInstallFirstTime"
    case userData = "com.user.userData"
  }
  ...
  static var userData: Data {
    set{
      ...
      return _get(valueForKay: .userData) as? Data ?? Data()
    }
  }
  ...
  static var isAppInstallFirstTime: Bool {
    set{
      _set(value: newValue, key: .isAppInstallFirstTime)
    }get{
      return _get(valueForKay: .isAppInstallFirstTime) as? Bool ?? true
    }
  }
  ...
  func clearAllUserDefaults() {
    if let bundleID = Bundle.main.bundleIdentifier {
      ...
      // Optionally, you can also synchronize to ensure immediate write to disk,
      // although it's often not strictly necessary in modern iOS.
